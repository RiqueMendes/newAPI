...
public class PessoaDAO extends DAO {
    ...
    public List<Pessoa> findAllNameAsc() throws SQLException {
    ...
    public Pessoa findPessoaById(int id) throws SQLException {
        try (PreparedStatement psmt = getConnection().prepareStatement("SELECT * FROM pessoa WHERE id= " + id )) {
            try (ResultSet rs = psmt.executeQuery()) {
            	final Pessoa pessoa = new Pessoa();
                while(rs.next()){ 
